	...
	window.data = {
		map:{
			...
			add_markers: [
				...
				googleMap.marker( { position: [24.2526852, 120.7302684], icon: 1, label: {text: '文化中心', color:'#446666', fontFamily:'fantasy,微軟正黑體'}, title: 'SEC', clusterName: 'A'}	),
