...
namespace {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model{
        ...
        /**
         * Add a "groups by" clause to the query.
         *
    ...
    class Lang extends \Illuminate\Support\Facades\Lang{
        ...
        /**
         * Load the specified language groups.
         *
        ...
        /**
         * Parse a key into namespace, groups, and item.
         *
         * @param string $key
         * @return array
         * @static
    ...
    class Route extends \Illuminate\Support\Facades\Route{
        ...
        /**
         * Create a route groups with shared attributes.
         *
         * @param array $attributes
         * @param \Closure $callback
         * @return void
        ...
        /**
         * Merge the given array with the last groups stack.
         *
         * @param array $new
         * @return array
         * @static
        ...
        /**
         * Merge the given groups attributes.
         *
         * @param array $new
         * @param array $old
         * @return array
        ...
        /**
         * Get the prefix from the last groups on the stack.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set a groups of global where patterns on all routes.
         *
        ...
        /**
         * Determine if the router currently has a groups stack.
         *
         * @return bool
         * @static
         */
        ...
        /**
         * Get the current groups stack for the router.
         *
         * @return array
         * @static
         */
